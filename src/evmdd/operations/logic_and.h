...
template <class T> struct logic_and {
...
#ifndef DEBUG
template <class T> void domain_check_and(const T &lhs, const T &rhs) {
...
template <> struct logic_and<double> {
...
template <> struct logic_and<float> {
