...
template <class T> struct logic_or {
...
#ifndef DEBUG
template <class T> void domain_check_or(const T &lhs, const T &rhs) {
...
template <> struct logic_or<double> {
...
template <> struct logic_or<float> {
